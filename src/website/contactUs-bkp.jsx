      ...
      <div className="cdiv">
        {/* <div className="cdiv-2">
          ...
          <div className="cdiv-3">
            <div className="cdiv-4">Home</div>
            <div className="cdiv-5">About Us</div>
            <div className="cdiv-6">Services</div>
            <div className="cdiv-7">Blog</div>
            <div className="cdiv-8">Contact Us</div>
          </div>
        </div> */}
          ...
          <div className="cdiv-28">
            <div className="cdiv-29">
              ...
              <span style={{fontFamily: 'Calibri, sans-serif',fontWeight: 400}}>
                23/1, Serenity Spaces, 1st Main Road,  Channama Layout, EPIP,
                Bangalore - 560048
                <br />
              </span>
              <span style={{fontFamily: 'Calibri, sans-serif',fontWeight: 400}}>
